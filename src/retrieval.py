"""
Jalon 3 - Recherche, et amélioration Jalon 6 - recherche hybride.
...
Combine :
  ...
  - recherche lexicale BM25, sur la question brute (utile pour "que dit
    L3121-1 ?", ou le numéro d'article est un signal exact que le vectoriel
    peut manquer)
...
est prevenu que la réponse peut être peu fiable.
"""
...
def hybrid_search(sub_questions: list, use_hyde: bool = True, top_k_final: int = TOP_K_FINAL) -> dict:
    ...
    sous-question seraient éliminés avant même d'atteindre le LLM - ce qui a
